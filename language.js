...
"donation_raised": "Arrecadado: 3724,71€",
"donate_button": "Doar",
...
"mission_text_5": "A Liberation Station é música, solidariedade e resistência. É a prova de que a cultura não tem de ser cúmplice, mas sim um espaço de denúncia, de comunidade e de luta.",
  ...
  "e1_desc": "O evento, exclusivamente transmitido por streaming, reúne um alinhamento eclético de artistas, desde GrandMaster Dre, que abre a sessão, até NSX3000, que encerra a noite. Cada apresentação é um apelo à ação e uma celebração da comunidade, com todos os fundos arrecadados revertidos diretamente para as famílias em Gaza.",
  "e2_date": "1 DE OUTUBRO",
  "e2_location": "LISBOA",
  "e2_name": "PASSEVITE",
  "e2_desc": "No dia 1 de Outubro, DJXpressMusic b2b Party Smith, Diana XL e Rita Maomenos b2b Sasha Theft trazem sets de ambiente, com uma conversa paralela para discussão no Passevite, em Lisboa. Todas as receitas revertem diretamente para as famílias em Gaza, apoiando necessidades urgentes através da música e da solidariedade.",
  "e3_date": "1 DE OUTUBRO",
  "e3_location": "LISBOA",
  "e3_name": "LISA",
  "e3_desc": "Junte-se a nós na Sala Lisa, em Lisboa, para uma noite de música ao vivo e DJ sets. Bint Mbareh atua ao vivo, seguido por Sérgio Hydalgo e Caroline Lethô b2b Veludo, com Hiroma Keo b2b Paixão a encerrar a noite. Todas as receitas revertem diretamente para as famílias em Gaza.",
  "e4_date": "2 DE OUTUBRO",
  "e4_location": "LISBOA",
  "e4_name": "SIRIGAITA",
  "e4_desc": "Junte-se a nós no Sirigaita, em Lisboa, para uma noite de música e convívio. O evento decorrerá das 19h30 às 23h00, com a programação a ser divulgada em breve. O evento também será transmitido ao vivo. Todas as receitas serão diretamente revertidas para as famílias em Gaza, tornando-se um momento de apoio e solidariedade.",
  "e5_date": "2 DE OUTUBRO",
  "e5_location": "LISBOA",
  "e5_name": "OUTRA CENA",
  "e5_desc": "Desde o concerto ao vivo de AEAAEA5 até Colell b2b XCI, Markov b2b Nicolle Velcro e DJ CVLT b2b Photonz, o alinhamento combina ritmos, palavras e movimento. Uma performance de poesia slam e um workshop de dabke acrescentam espaços para expressão e conexão. Todas as receitas revertem diretamente para as famílias em Gaza.",
  ...
  "e7_desc": "No dia 3 de Outubro, no Passos Manuel, no Porto, com atuações ao vivo e híbridas, palestras paralelas e atuações consecutivas de Peyvand, ASTREA b2b HOFICYO, Ca0stica b2b DJ Sem Futuro e Boxia b2b Noia. Cada bilhete vendido apoia famílias em Gaza. Transmissão ao vivo partilhada no dia.",
  "e8_date": "4 DE OUTUBRO",
  "e8_location": "OPORTO",
  "e8_name": "PEDREIRA",
  "e8_desc": "Junte-se a nós na Pedreira, no Porto, para uma tarde de sets consecutivos, apresentações ao vivo e uma palestra paralela. De Beatz b2b Sucata e Chan Yok b2b Furaviaa ao set ao vivo de DJ Lynce e Tefi b2b Ugho, o dia mistura música, conversa e solidariedade. Todas as receitas revertem diretamente para as famílias em Gaza, o que faz com que cada presença conte.",
  "e9_date": "5 DE OUTUBRO",
  "e9_location": "SANTO TIRSO",
  "e9_name": "ALÍNEA A",
  "e9_live": "TRANSMISSÃO AO VIVO",
  "e9_desc": " No dia 5 de Outubro, sintonize-se em qualquer lugar para uma noite de música transmitida ao vivo pela Alínea A em Santo Tirso: Peter Mor e Mar710, Photonz, Astrea e NOIA, cada apresentação traz energia e conexão. Cada transmissão apoia famílias em Gaza, não se esqueça de partilhar e doar.",
...
"faq_a1": "Somos um coletivo de mais de trinta amigos e amigos de amigos espalhados por todo o país, na sua maioria ligados à música como artista, produtor, entre outros. Organizamo-nos de forma totalmente voluntária, sem fins lucrativos, para criar um evento que denuncie a utilização da cultura como ferramenta de propaganda sionista e que, ao mesmo tempo, apoie diretamente famílias palestinianas em Gaza.",
"faq_q2": "Vai ser preciso pagar entrada nos eventos?",
"faq_a2": "Depende do local. Em alguns eventos haverá entrada livre com donativo voluntário à porta. Noutros, por exigência do espaço, será cobrada uma entrada. Temos acordos com estes espaços para que uma percentagem das entradas e do bar revertam para a nossa campanha de apoio às famílias em Gaza (info mais detalhada a ser partilhada em breve).",
"faq_q3": "Como posso doar?",
"faq_a3": "Online (site oficial): Todas as doações através do nosso site são feitas através do PayPal e vão diretamente para a Associação Juvenil CulturMais, NIPC 510862110, uma associação legalmente registada em Portugal.\nNos eventos: As doações podem ser feitas em dinheiro ou por MB Way. Neste caso, por limitações técnicas, o MB Way será recebido temporariamente através das contas pessoais da equipa local e transferido para a conta da associação.",
"faq_q4": "Porque é que as doações vão para uma associação?",
"faq_a4": "Como o projeto não tem uma conta bancária própria, escolhemos recorrer a esta associação de forma a permitir que toda a gestão financeira seja feita de forma centralizada, segura e organizada. É na conta da associação que centralizamos os fundos recolhidos e é a partir dela que são feitas as transferências para as famílias. Esta campanha foi formalmente aprovada pela direção da associação, que autorizou a angariação e a distribuição dos fundos.",
"faq_q5": "Porque é que as doações nos eventos passam por contas MB Way pessoais?",
"faq_a5": "Infelizmente, a associação não tem MB Way e, por limitações técnicas, não conseguimos integrar este método de pagamento no nosso site. Sendo que é um dos métodos de pagamento mais utilizado em Portugal, não queremos deixar esta opção de fora e optámos por disponibilizar os nossos números de MB Way pessoais nos eventos. Sabemos que esta não é a solução ideal. Por isso, todos os valores recebidos por MB Way (assim como em cash) são posteriormente transferidos e centralizados na conta da associação. Iremos publicar recibos e atualizações para garantir que cada euro é devidamente contabilizado.",
"faq_q6": "Para onde vão os fundos?",
"faq_a6": "A associação distribui 100% do valor angariado para famílias em Gaza através das suas campanhas pessoais no GoFundMe e plataformas semelhantes, que são atualmente os principais canais através dos quais a população de Gaza consegue receber ajuda. Com o aconselhamento de parceiros nossos que mantêm amizade e contacto regular com várias famílias, no final da campanha faremos a distribuição tendo em conta as que tiverem maior necessidade nesse momento. Para garantir transparência, iremos publicar os comprovativos de todas as transferências nas nossas plataformas.",
